...
# %%
df_detail = pd.read_sql(summary_sql, con)
...
df_detail['预算主体名称'] = df_detail['预算主体名称'].map(func)
...
df_detail.to_sql("预算执行报表汇总", con = conx,chunksize=20000,index=False, if_exists="replace")
